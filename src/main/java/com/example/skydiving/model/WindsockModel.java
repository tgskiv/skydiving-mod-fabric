...
public class WindsockModel extends Model {
    ...
    public WindsockModel(ModelPart root) {
        ...
        super(RenderLayer::getEntitySolid); // Default render layer
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData basePart = root.addChild("base", ModelPartBuilder.create()
        ...
        ModelPartData conePart = root.addChild("cone", ModelPartBuilder.create()
